...
class User(models.Model):
    ...
    last_login = models.DateTimeField(blank=True, null=True, default=None)  # For Django auth token compatibility
    date_joined = models.DateTimeField(default=timezone.now)  # For Django auth token compatibility
